class car{
    ...
    getDescription() {
        let description = this.brand + "," + this.model + "," + this.yearofmanufacture + "," + this.seats;
    }
}
...
class electriccar{
    ...
    getDescription() {
        let description = this.brand + "," + this.model + "," + this.yearofmanufacture + "," + this.seats + "," + this.batteryrange + "km";
    }
}
